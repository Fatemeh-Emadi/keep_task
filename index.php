        ...
        <main>
          ...
          <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
              ...
              <li class="list-group-item-action">
                <a href="edit_notes.php" class="nav-link text-white">
                  <i class="fa fa-pen"></i>
                  Edit labels
                </a>
              </li>
              ...
              <li class="list-group-item-action">
                <a href="remove_notes.php" class="nav-link text-white">
      ...
      <div class="col-6 text-light mt-5 bg-secondary  rounded" style="height:360px;">
        <form action="add_task_process.php" method="post">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Take a note" name="note"></textarea>
          </div>
          <div class="row mb-3">
            <div class="col-3">
            ...
            <div class="col-3 ">
              ...
              <input type="color" class="form-control form-control-color" id="exampleColorInput" value="#563d7c" title="Choose your color" style="width:50px; height:40px;" name="color">
            </div>
            <div class="col-3 ">
...
<?php foreach ($tasks as $task) : ?>
  <div class="col mt-3 mb-3" >
    <div class="card" style=" background: <?php echo $task["color"]; ?>;">

      <div class="card-body">
        <h5 class="card-title"><?php echo $task["title"]; ?></h5>
        <p class="card-text"><?php echo $task["note"]; ?></p>
        <span>
          <p class="card-text"><i class="fa fa-clock"></i> <?php echo $task["time"]; ?></p>
        </span>
        <span>
          <p class="card-text"><i class="fa fa-calendar"></i> <?php echo $task["date"]; ?></p>
        </span>
        <hr>
        <a class="btn btn-sm btn-outline-light"
                               href="task_edit_notes.php?task_id=<?php echo $task["id"]; ?>">
